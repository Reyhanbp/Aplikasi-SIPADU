...
<div class="card"> <div class="card-header"> <div class="card-title text w-100 d-flex justify-content-between">
    <h4 class="fw-bold mb-2">
        <span class=" text-muted fw-light">Data Pindah / </span> Tambah Data Pindah
    </h4>
    <div>
        <a class="btn btn-danger" role="button" href="{{ route ('pindah') }}">
...
<hr>
<form action="{{route('Send-pindah')}}" method="POST" enctype="multipart/form-data">
    @csrf
    <div class="card-body">
    <div class="row">
        <div class="col-6">
        ...
        <div class="col-12">
            <div class="mb-3">
                ...
                <textarea id="sebab_pindah" name="sebab_pindah" class="form-control" rows="2"
                    placeholder="Sebab Pindah"></textarea>
            </div>
        </div>
    </div>
    <div class="col-12">
