...
<div class="card"> <div class="card-header"> <div class="card-title text w-100 d-flex justify-content-between">
    <h4 class="fw-bold mb-2">
        <span class=" text-muted fw-light">Data Meninggal / </span> Tambah Data Meninggal
    </h4>
    <div>
...
<hr>
<form action="{{route('Send-meninggal')}}" method="POST" enctype="multipart/form-data">
    @csrf
    <div class="card-body">
    <div class="row">
        <div class="col-6">
        ...
        <div class="col-6">
            <div class="mb-3">
                ...
                <input type="date" name="tgl_meninggal" id="tgl_meninggal" class="form-control" required autoComplete="off" />
            </div>
        </div>
        <div class="col-12">
            <div class="mb-3">
                ...
                <textarea id="sebab_meninggal" name="sebab_meninggal" class="form-control" rows="2"
                    placeholder="Sebab Meninggal"></textarea>
            </div>
        </div>
    </div>
    <div class="col-12">
