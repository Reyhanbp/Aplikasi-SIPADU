    ...
    <div class="card-header ">
      <div class="d-flex justify-content-between">
          <div class="card-title text w-100 d-flex justify-content-between">
              <h4 class="fw-bold">
                  <span class=" text-muted fw-light">Index Galery / </span> Galery
              </h4>
          </div>
           <div class="col-4 ms-md-3 pe-md-3 d-flex align-items-center">
            ...
            <div class="mt-3" >
             <a class="btn btn-3 btn-primary w-200" type="button" style="width: 150px;"  href="{{ route ('tambah-gallery') }}">
           ...
           <div class="card mb-5">
                <div class="table-responsive">
                    ...
                    <thead>
                        ...
                        <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Judul Foto</th>
                    ...
                    <tbody>
                        ...
                        <td>{{$galery ->jdl_gallery }}</td>
                        <td>
                                <img src="{{ asset('/storage/'.$galery->gallery) }}" alt="test"
                                width="50px" >
                            </td>

                        <td class="text-center align-middle" >
                            <form action="{{ route ('delete-gallery', $galery->id) }}" method="POST">
                                @csrf
                                @method('DELETE')
                                <a class="btn btn-warning" role="button"  href="{{ route ('edit-gallery', $galery->id) }}">
