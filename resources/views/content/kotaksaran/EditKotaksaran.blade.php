...
<div class="card">
    <div class="card-header">
      ...
      <h4 class="fw-bold  mb-2">
          <span class=" text-muted fw-light">Kotak Saran  / </span> Edit Kotak Saran
        </h4>
        <div>
      ...
      <hr>
        <form action="{{ route ('update-kotaksaran', $KotakSaran->id) }}" method="POST" enctype="multipart/form-data">
          @csrf
        <div class="card-body">
        <div class="row">
              <div class="">
                ...
                <div class="col-12">
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="desc_saran" name="desc_saran" rows="3" placeholder="Deskripsi">{{$KotakSaran->desc_saran}}</textarea>
                    </div>
                </div>
            </div>
