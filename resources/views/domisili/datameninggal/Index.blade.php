...
<div class="card mb-5"> <form class="me-5 ms-5 mt-5 mb-5" action="{{ route('cetakmeninggal') }}" method="POST"> @csrf
    <div class="row">
    <div class="col-12"> <div class="mb-3"> <label for="data_penduduk_id" class="required"> Nama Penduduk: </label>
